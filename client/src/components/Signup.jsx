...
import Googole from '../assets/gg.svg';

function Signup() {
    const {} = useContext(AuthContext);

    const { createUser, loginwitGoogle } = useContext(AuthContext);
                        ...
                        <div className="divide-y divide-gray-200">
                            <form onSubmit={handleSubmit} className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                ...
                                <p>
                                    ...
                                    <Link to="/login" className="text-blue-600">Log in here</Link>
                                </p>
                                <div className="relative">
                                    <button type="submit" className="bg-blue-500 text-white rounded-md px-2 py-1">Sign up</button>
                                    <hr/>
                                    <div className='flex w-full items-center flex-col mt-5 gap-3 '>
                                        <button className='block' ><img src={Googole} className='w-12 h-12 inline-block rounded' onClick={handelRegiste} alt="Google Logo"></img>Login with Google</button>
                                    </div>
                                </div>
                            </form>
                        </div>
