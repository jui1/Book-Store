...
import imagee from "../assets/awardbooks.png"
  ...
  return (
    <div className='mt-16 py-12 bg-teal-100 px-4 lg:px-24'>
      ...
      <div className='md:w-1/2'>
        <h2 className='text-4xl font-bold mb-6 leading-sung'>wards2023 National Book Awards for Fiction Shortlist</h2>
